...
```bash
curl -fsSL https://raw.githubusercontent.com/kdinstall/system-base/master/script/start.sh | bash
```
...
```bash
curl -fsSL https://raw.githubusercontent.com/kdinstall/system-base/master/test/start.sh | bash
```
